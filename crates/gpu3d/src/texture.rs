...
//! opaque except for the optional transparent color 0. The 4×4 compressed format
//! (5) is not yet decoded — it needs the paired slot-1 index data — and samples as
//! transparent for now.
//!
...
impl TexParams {
    ...
    pub fn sample(&self, tex: &TextureSet, s: i32, t: i32) -> Texel {
        ...
        match self.format {
            ...
            _ => Texel::default(), // 0 = none, 5 = 4×4 (unsupported) → transparent
        }
    }
