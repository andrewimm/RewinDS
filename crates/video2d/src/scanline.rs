...
mod generalization_tests {
    ...
    fn bg_base_offsets_shift_the_sampled_addresses() {
        ...
        ppu.layout = VramLayout { bg_char_base: 0x8000, bg_screen_base: 0x4000, obj_tile_base: 0x1_0000, obj_tile_boundary: 32 };
    ...
    fn obj_tile_base_is_honored() {
        let mut ppu = TestPpu::new();
        ppu.layout = VramLayout { bg_char_base: 0, bg_screen_base: 0, obj_tile_base: 0x2_0000, obj_tile_boundary: 32 };
